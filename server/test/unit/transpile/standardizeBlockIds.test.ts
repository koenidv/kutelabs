...
describe("standardizeBlockIds", () => {
  describe("standardization", () => {
    test("removes original ids", () => {
    ...
    test("does not affect remaining code", () => {
    ...
    test("only applies in markBlock calls", () => {
  ...
  describe("standardization-restoration", () => {
